...
<html lang="en">
  <head>
    ...
    <title>Detail Kamera Nikon D5100</title>
  </head>
  <body>
			...
			<div class="row">
				...
				<div class="col-sm-7 mt-2">
					...
					<i class="fas fa-star"></i>
				   	...
				   	<p><i class="fas fa-caret-right mr-2"></i>Megapixel : 24 MP</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>Tipe Memori : Kartu SD</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>Filter : Pembersih Jerawat dan Penghalus Kulit</p>
				   	<p><i class="fas fa-caret-right mr-2  mb-4"></i>Gratis : Kulit Putih Bersih</p><br>
				   	<p>Hanya Ada 1 Stok Didunia</p>
				   	<p style="font-size: 25px;" class="font-weight-bold">Rp. 50.000.000,00</p>
