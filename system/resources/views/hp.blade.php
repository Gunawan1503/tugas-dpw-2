  ...
  <body>
	...
	<div class="row no-gutters">
		...
		<div class="col-md-9">
			<div class="row">
				<div class="col-sm-5">
					<img style="width: 410px;" src="system/resources/assets/rekomendasi/hp-core15.jfif" alt="">
				</div>
				<div class="col-sm-7 mt-2">
					<h3>Laptop HP Gen 8 Radeon 2 GB</h3>
					<i class="fas fa-star"></i>
				   	<i class="fas fa-star"></i>
				   	<i class="fas fa-star"></i>
				   	<i class="fas fa-star"></i>
				    <i class="fas fa-star-half-alt"></i><br><br>
				   	<h4 class="text-danger">Spesifikasi</h4>
				   	<p><i class="fas fa-caret-right mr-2"></i>Prosesor : Intel Core i5 Gen 8 Radeon</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>RAM : 4 GB</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>OS : Windows 10 Home Original 64 Bit</p>
				   	<p><i class="fas fa-caret-right mr-2  mb-4"></i>HDD : 1 TB HDD</p><br>
				   	<p>Tersedia > 50 Stok Barang</p>
				   	<p style="font-size: 25px;" class="font-weight-bold">Rp. 10.000.000,00</p>
				   	<button class="btn btn-outline-dark"><i class="fas fa-comment-dots mr-2"></i>Chat</button>
				   	<button class="btn btn-outline-dark"><i class="fas fa-shopping-cart mr-2"></i>Masukkan Keranjang</button>
