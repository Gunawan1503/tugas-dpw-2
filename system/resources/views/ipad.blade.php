...
<html lang="en">
  <head>
    ...
    <title>Detail Ipad 12 Pro</title>
  </head>
  <body>
			...
			<div class="row">
				...
				<div class="col-sm-7 mt-2">
					...
					<i class="fas fa-star"></i>
				   	...
				   	<p><i class="fas fa-caret-right mr-2"></i>Prosesor : Snapdragon 865</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>RAM : 6 GB</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>Kapasitas : 256 GB</p>
				   	<p><i class="fas fa-caret-right mr-2  mb-4"></i>Ukuran Layar : 12.9 Inci</p><br>
				   	<p>Tersedia > 500 Stok Barang</p>
				   	<p style="font-size: 25px;" class="font-weight-bold">Rp. 11.500.000,00</p>
