...
<html lang="en">
  <head>
    ...
    <title>Detail Realme 8 Pro</title>
  </head>
  <body>
		...
		<div class="col-md-9">
			<div class="row">
				<div class="col-sm-5 mt-2">
					<img style="width: 430px;" src="system/resources/assets/rekomendasi/realme-8pro.jpg" alt="">
				</div>
				<div class="col-sm-7 mt-2">
					...
					<i class="fas fa-star"></i>
				   	...
				   	<p><i class="fas fa-caret-right mr-2"></i>Prosesor : Qualcomm Snapdragon 720G</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>RAM : 8 GB</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>Kamera Depan : 32 
				   	MP</p>
				   	<p><i class="fas fa-caret-right mr-2  mb-4"></i>Kamera Belakang : 64 MP</p><br>
				   	<p>Tersedia > 70 Stok Barang</p>
				   	<p style="font-size: 25px;" class="font-weight-bold">Rp. 6.500.000,00</p>
