  ...
  <body>
	...
	<div class="row no-gutters">
		...
		<div class="col-md-9">
			<div class="row mt-3">
				<div class="col-sm-5">
					<img style="width: 490px;" src="system/resources/assets/rekomendasi/acer.jpg" alt="">
				</div>
				<div class="col-sm-7 mt-2">
					<h3>Laptop Acer Predator</h3>
				    ...
				    <i class="fas fa-star"></i>
				   	...
				   	<p><i class="fas fa-caret-right mr-2"></i>Prosesor : Intel Core i7-7700HQ 2.8-3,8Ghz</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>RAM : 16GB DDR4</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>OS : Windows 10 Home Original 64 Bit</p>
				   	<p><i class="fas fa-caret-right mr-2  mb-4"></i>HDD : 1TB + SSD 256GB</p><br>
				   	<p>Tersedia > 1000 Stok Barang</p>
				   	<p style="font-size: 25px;" class="font-weight-bold">Rp. 37.500.000,00</p>
