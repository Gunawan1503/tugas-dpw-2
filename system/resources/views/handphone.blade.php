...
<html lang="en">
  <head>
    ...
    <title>Detail Iphone 8 Plus</title>
  </head>
  <body>
	...
	<div class="row no-gutters">
		...
		<div class="col-md-9">
			<div class="row">
				<div class="col-sm-5">
					<img style="width: 460px;" src="system/resources/assets/rekomendasi/iphone.jpg" alt="">
				</div>
				<div class="col-sm-7 mt-2">
					...
					<i class="fas fa-star"></i>
				   	...
				   	<p><i class="fas fa-caret-right mr-2"></i>Prosesor : Snapdragon 845</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>RAM : 3 GB</p>
				   	<p><i class="fas fa-caret-right mr-2"></i>Kamera Depan : 7 MP</p>
				   	<p><i class="fas fa-caret-right mr-2  mb-4"></i>Kamera Belakang : 12 MP</p><br>
				   	<p>Tersedia > 400 Stok Barang</p>
				   	<p style="font-size: 25px;" class="font-weight-bold">Rp. 10.500.000,00</p>
